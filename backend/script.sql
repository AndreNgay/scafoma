...
CREATE TABLE IF NOT EXISTS public.tblcart
(
    id serial NOT NULL,
    user_id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT tblcart_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS public.tblcartdetail
(
    id serial NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT tblcartdetail_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS public.tblcartitemvariation
(
    id serial NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT tblcartitemvariation_pkey PRIMARY KEY (id)
);
...
ALTER TABLE IF EXISTS public.tblcart
...
ALTER TABLE IF EXISTS public.tblcartdetail
    ADD CONSTRAINT fk_cart FOREIGN KEY (cart_id)
    REFERENCES public.tblcart (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE;


ALTER TABLE IF EXISTS public.tblcartdetail
    ADD CONSTRAINT fk_cart_item FOREIGN KEY (item_id)
    REFERENCES public.tblmenuitem (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE;


ALTER TABLE IF EXISTS public.tblcartitemvariation
    ADD CONSTRAINT fk_cart_variation FOREIGN KEY (variation_id)
...
ALTER TABLE IF EXISTS public.tblcartitemvariation
    ADD CONSTRAINT fk_cartdetail_variation FOREIGN KEY (cart_detail_id)
    REFERENCES public.tblcartdetail (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE;
